...
public class SecuritiesInqrPritMgmtVo extends com.inswave.eladmin.cmmn.DemoCommVO {
    ...
    @ElDtoField(logicalName = "스팟환율", physicalName = "spotEcrt", type = "String", length = 0)
    private String spotEcrt;

    @ElDtoField(logicalName = "환율단위가", physicalName = "ecrtUnitVl", type = "BigDecimal", length = 0)
    private BigDecimal ecrtUnitVl;
    ...
    public Integer getSpotEcrt() {
        return spotEcrt;
    }

    public void setSpotEcrt(String spotEcrt) {
        this.spotEcrt = spotEcrt;
    }

    public Integer getEcrtUnitVl() {
        return ecrtUnitVl;
    }

    public void setEcrtUnitVl(String ecrtUnitVl) {
        this.ecrtUnitVl = ecrtUnitVl;
    }
}